...
public static class DependencyInjection
{
    ...
    {
        services.AddDbContext<DinnerDbContext>(options => options.UseSqlServer("Data Source=localhost;Initial Catalog=DinnerDDD;Integrated Security=True;TrustServerCertificate=True; "));
